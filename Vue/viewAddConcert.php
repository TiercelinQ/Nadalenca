<form method="POST" action="./controlValidAddConcert.php">
					<fieldset>
						<legend>Formulaire d'ajout de concert</legend>
							...
							<label>Jour : </label><input type="text" name="jour" placeholder="jours" required><br />
							...
							<label>Minute : </label><input type="number" name="miute" placeholder="minute" required><br />
